...
const DisplayCartItem = ({close}) => {
  ...
  return (
    <section className='fixed top-0 bottom-0 right-0 left-0 bg-black/50 z-50' onClick={close}>
        <div className='bg-white w-full md:w-[400px] min-h-screen max-h-screen ml-auto' 
