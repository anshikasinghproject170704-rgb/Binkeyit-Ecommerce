...
const CategoryWiseProductDisplay = ({ id, name }) => {
    ...
    const handleRedirectProductListpage = () => {
        // 1. Try to find a subcategory for this main category
        ...
        // --- FIX STARTS HERE ---
        // 2. Safety Check: If no subcategory found, don't return a broken URL
        if (!subcategory) {
            // console.warn("No subcategory found for:", name);
            return "#"; // Return a dummy link or handle it differently
        }
        // --- FIX ENDS HERE ---
    ...
    return (
        <div>
            <div className='container mx-auto p-4 flex items-center justify-between gap-4'>
                ...
                {/* Only show "See All" if we actually have a valid link */}
